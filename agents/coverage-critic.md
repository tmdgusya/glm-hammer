...
Your prompt includes an evidence file path. Before returning, write your FULL report (the `VERDICT:` line first, then findings with quotes) to that path via Bash, creating parent directories. Then end your final message with exactly:
